                    ...
                    <div class="isi">
                        ...
                        <table width="100%" class="table-data table-responsive">
                            ...
                            <tbody>
                                <?php
                                $no = 1;
                                $sql = $koneksi->query("SELECT DATE_FORMAT(penjualan.tanggal, '%m-%Y') as tanggal, sum(penjualan.total_harga) as jumlah FROM penjualan
                                GROUP BY DATE_FORMAT(penjualan.tanggal, '%Y-%m')");
